...
this.btnList = {
    ...
    "bold":           ['Bold',                 '加粗',               'editor_action(this.id)',  '../_editer/images/ed_format_bold.gif'],
    "italic":         ['Italic',               '斜体',             'editor_action(this.id)',  '../_editer/images/ed_format_italic.gif'],
    "underline":      ['Underline',            '下划线',          'editor_action(this.id)',  '../_editer/images/ed_format_underline.gif'],
    "strikethrough":  ['StrikeThrough',        'Strikethrough',      'editor_action(this.id)',  '../_editer/images/ed_format_strike.gif'],
    "subscript":      ['SubScript',            'Subscript',          'editor_action(this.id)',  '../_editer/images/ed_format_sub.gif'],
    "superscript":    ['SuperScript',          'Superscript',        'editor_action(this.id)',  '../_editer/images/ed_format_sup.gif'],
    "justifyleft":    ['JustifyLeft',          '左对齐',       'editor_action(this.id)',  '../_editer/images/ed_align_left.gif'],
    "justifycenter":  ['JustifyCenter',        '居中',     'editor_action(this.id)',  '../_editer/images/ed_align_center.gif'],
    "justifyright":   ['JustifyRight',         '右对齐',      'editor_action(this.id)',  '../_editer/images/ed_align_right.gif'],
    "orderedlist":    ['InsertOrderedList',    '列表',       'editor_action(this.id)',  '../_editer/images/ed_list_num.gif'],
    "unorderedlist":  ['InsertUnorderedList',  '列表2',      'editor_action(this.id)',  '../_editer/images/ed_list_bullet.gif'],
    "outdent":        ['Outdent',              '左缩进',    'editor_action(this.id)',  '../_editer/images/ed_indent_less.gif'],
    "indent":         ['Indent',               '右缩进',    'editor_action(this.id)',  '../_editer/images/ed_indent_more.gif'],
    "forecolor":      ['ForeColor',            '字体颜色',         'editor_action(this.id)',  '../_editer/images/ed_color_fg.gif'],
    "backcolor":      ['BackColor',            '背景颜色',   'editor_action(this.id)',  '../_editer/images/ed_color_bg.gif'],
    "horizontalrule": ['InsertHorizontalRule', '水平线',    'editor_action(this.id)',  '../_editer/images/ed_hr.gif'],
    "createlink":     ['CreateLink',           '超连接',    'editor_action(this.id)',  '../_editer/images/ed_link.gif'],
    "insertimage":    ['InsertImage',          '插入图片',       'editor_action(this.id)',  '../_editer/images/ed_image.gif'],
    "inserttable":    ['InsertTable',          '插入表格',       'editor_action(this.id)',  '../_editer/images/insert_table.gif'],
    "htmlmode":       ['HtmlMode',             '编辑HTML',   'editor_setmode(\''+objname+'\')', '../_editer/images/ed_html.gif'],
    "popupeditor":    ['popupeditor',          '新窗口中编辑',     'editor_action(this.id)',  '../_editer/images/fullscreen_maximize.gif'],
    "about":          ['about',                '版权说明',  'editor_about(\''+objname+'\')',  '../_editer/images/ed_about.gif'],

    // Add custom buttons here:
    "custom1":           ['custom1',         'Purpose of button 1',  'editor_action(this.id)',  '../_editer/images/ed_custom.gif'],
    "custom2":           ['custom2',         'Purpose of button 2',  'editor_action(this.id)',  '../_editer/images/ed_custom.gif'],
    "custom3":           ['custom3',         'Purpose of button 3',  'editor_action(this.id)',  '../_editer/images/ed_custom.gif'],
   // end: custom buttons

    "help":           ['showhelp',             'Help using editor',  'editor_action(this.id)',  '../_editer/images/ed_help.gif']};
...
function editor_generate(objname,userConfig) {
  ...
  for (var btnGroup in config.toolbar) {
    ...
    for (var btnItem in config.toolbar[btnGroup]) {
    	alert('btnGroup=========='+btnGroup);
    	alert('btnItem=========='+btnItem);
      var btnName = config.toolbar[btnGroup][btnItem].toLowerCase();
alert('ffffffffffffffffffffffffffffff===='+btnName);
      // fontname
      if (btnName == "fontname") {
