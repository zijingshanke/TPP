	...
	<body>
		<div id="mainContainer">
			...
			<div class="closeSiseBar">
			  ...
			  -->
			<div id="container">
				<html:form action="/system/citylist.do">
...
<c:import url="../_jsp/mainTitle.jsp?title1=银行管理&title2=银行列表" charEncoding="UTF-8" />
	<div class="searchBar">
									...
									<table cellpadding="0" cellspacing="0" border="0"
										class="searchPanel">
										<tr>
											<td>省<html:select property="provinceId" onchange="searchUser();">
												<html:option value="0">请选择</html:option>													
												<html:options collection="provinces" property="id" labelProperty="cname"/>
												</html:select>
												<a href="../system/provincelist.do?thisAction=list">新增</a>		</td>
											<td>
												市(中文)
													<html:text property="city.cname"></html:text>	
											</td>
											<td>
												市(英文)	
												<html:text property="city.ename"></html:text>	
											</td>			
											<td>
												<c:check code="sg02">
								...
								<table width="100%" cellpadding="0" cellspacing="0" border="0"
									...
									<c:forEach var="info" items="${clf.list}" varStatus="status">
										<tr>
											...
											<td>
												<c:out value="${info.province.cname}" />
											</td>
													<td>
												<c:out value="${info.province.ename}" />
											</td>
											<td>
