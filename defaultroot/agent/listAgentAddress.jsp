...
<c:import url="../_jsp/mainTitle.jsp?title1=商户管理&title2=联系人地址信息" charEncoding="UTF-8" />
								...
								<table width="100%" cellpadding="0" cellspacing="0" border="0"
									...
									<c:forEach var="info" items="${alf.list}" varStatus="status">
										...
										<td><c:out value="${info.postCode}"></c:out></td>
										<td><c:out value="${info.tel}"></c:out></td>
										<td><c:out value="${info.mtel}"></c:out></td>
										<td><c:out value="${info.memo}"></c:out></td>
										</tr>
									</c:forEach>
