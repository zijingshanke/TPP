...
function download(){
	...
	document.forms[0].action="../transaction/chargelist.do?thisAction=downloadGeneralCharge";
	document.forms[0].submit();
	document.forms[0].action="../transaction/chargelist.do?thisAction=listGeneralCharge";
}
</script>
	...
	<body>
		<div id="mainContainer">
			<div id="container">
				<html:form action="/transaction/chargelist.do?thisAction=listGeneralCharge" >
...
<c:import url="../_jsp/mainTitle.jsp?title1=充值管理&title2=普通充值列表" charEncoding="UTF-8" />
								<div class="searchBar">
									<p>
										搜索栏
									</p>
								...
								<table width="100%" style="margin-top: 5px;">
									<tr>
										<td><input type="button" value="下载普通充值报表" class="button3" onclick="download();"/></td>
										<td align="right">
