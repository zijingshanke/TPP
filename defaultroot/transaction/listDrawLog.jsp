...
function smb()
{
	...
	<body>
		<div id="mainContainer">
			<div id="container">
				<html:form action="/transaction/drawLoglist.do" >
...
<c:import url="../_jsp/mainTitle.jsp?title1=提现管理&title2=提现日志" charEncoding="UTF-8" />
								<div class="searchBar">
									<p>
										搜索栏
									</p>
								...
								<table width="100%" cellpadding="0" cellspacing="0" border="0"
									...
									<c:forEach var="info" items="${clf.list}" varStatus="status">
										<tr>
											...
											<td>
											<html:link page="/transaction/drawLoglist.do?thisAction=listDrawLogByContent&orderNo=${info.orderNo}">
