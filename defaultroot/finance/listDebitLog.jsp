...
function smb()
{
	...
	<body>
		<div id="mainContainer">
			<div id="container">
				<html:form action="/transaction/debitLoglist.do" >
...
<c:import url="../_jsp/mainTitle.jsp?title1=交易管理&title2=预支日志" charEncoding="UTF-8" />
								<div class="searchBar">
									<p>
										搜索栏 
									</p>
								...
								<table width="100%" cellpadding="0" cellspacing="0" border="0"
									...
									<c:forEach var="info" items="${dlof.list}" varStatus="status">
										<tr>
											<td>
												<c:out
													value="${status.count+(dlof.intPage-1)*dlof.perPageNum}" />
											</td>
											<td>
												<c:out value="${info.chargeDate}" />
											</td>
											<td>
											<html:link page="/transaction/debitLoglist.do?thisAction=listDebitByContent&orderNo=${info.debitNo}">
												<c:out value="${info.debitNo}" />
												</html:link>
											</td>
											<td>
												<html:link
								...
								<table width="100%" style="margin-top: 5px;">
									<tr>
										...
										<td align="right">
											<div>
												共有记录&nbsp;
												<c:out value="${dlof.totalRowCount}"></c:out>
												&nbsp;条&nbsp;&nbsp;&nbsp;&nbsp; [
												...
												页数:
												<c:out value="${dlof.intPage}" />
												/
												<c:out value="${dlof.pageCount}" />
												]
											</div>
										</td>
									</tr>
