 ...
 * @外联平台余额查询，一次往返
 */
public class AccountInformation extends EbsConnection {
	...
	public AccountInformation() {
		init();
		this.ACC_NO="44001646343053000762";
	}

	public String getAmountInfomationCmd() {
		String cmd = "";
		EbsConnection con = new EbsConnection();
		con.setTX_CODE("6W0100");
		StringBuffer str = con.getTransactionHeader();
		str.append("<TX_INFO>");
		str.append("<ACC_NO>" + this.getACC_NO() + "</ACC_NO>");
		str.append("</TX_INFO>");
		str.append("</TX>");
		cmd = str.toString();
		return cmd;
