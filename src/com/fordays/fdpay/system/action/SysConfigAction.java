...
public class SysConfigAction extends BaseAction {
	...
	public ActionForward add(ActionMapping mapping, ActionForm form,
		...
		sysconfig.setActive(SysConfig.ACTIVE_YES);
	...
	public ActionForward insert(ActionMapping mapping, ActionForm form,
		...
		try {
			...
			inf.setMessage("增加参数出错！错误信息是：" + ex.getMessage());
			inf.setBack(true);
		}
	...
	public ActionForward update(ActionMapping mapping, ActionForm form,
		...
		try {
			...
			temp.setValue(sclf.getSysConfig().getValue());
			sysConfigBiz.updateSysConfig(temp);

			inf.setMessage("您已经成功更新了参数资料！");
			inf.setForwardPage("/system/sysConfigList.do");
			inf.setParamId("thisAction");
			inf.setParamValue("list");

		} catch (Exception ex) {
			inf.setMessage("更新参数资料出错！错误信息是：" + ex.getMessage());
			inf.setBack(true);
		}
		request.setAttribute("inf", inf);
		forwardPage = "inform";
